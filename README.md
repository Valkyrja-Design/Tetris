The code for the Tetris game I made using the Godot engine. While the UI looks bland(very bland), I've tried to make up for it by implementing features like NEXT_PIECE, the 
